...
export function HeroGeometricBackground() {
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden bg-neutral-950 pointer-events-none z-0 opacity-60">
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/[0.08] via-transparent to-rose-500/[0.08] blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
      <div className="absolute inset-0 overflow-hidden">
        <ElegantShape
          delay={0.1}
          width={350}
